...
export const privacySections: PrivacySection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Referral program: referral codes and links you share, attribution when someone signs up via your link, qualified referral counts, and reward grant history (for example Premium trials or badges).",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Store your profile, tasks, focus stats, achievements, referral rewards, voice notes, and room preferences.",
